...
function MenuItems({ children, icon = "arrow-right",  href, onClick }: MenuItemProps) {
    const baseClass = 'px-3 pl-8.5 py-1 text-sm font-medium w-full text-start rounded-md text-white '
        ...
        if (isExternal) {
            return (
                <li className="list-none relative">
                    <Icon name={icon} size={14} className="absolute top-1.5 left-3 fill-primary" />
