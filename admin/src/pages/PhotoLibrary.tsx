...
function PhotoLibrary({grid , objectFit}: PhotoLibraryProps) {
    ...
    var fit: string = objectFit ? " md:object-cover": " md:object-contain";
            ...
            >
                {gallery.map((_, idx) => (
                    <div key={idx} className="photo relative aspect-square h-full overflow-clip group">
                        <img className={"h-full w-full object-cover group-hover:scale-110 duration-200 group-hover:opacity-80" + fit} src={gallery[idx].path} alt=""  />
